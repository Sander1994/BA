...
\lstset{
	language=Python,                % Sprache des eingefügten Codes
	basicstyle=\ttfamily,          % Stil der Schrift
	commentstyle=\color{green},    % Stil der Kommentare
	keywordstyle=\color{blue},     % Stil der Schlüsselwörter
	stringstyle=\color{red},       % Stil von Strings
	numbers=left,                  % Zeilenummern links anzeigen
	numberstyle=\tiny,             % Stil der Zeilenummern
