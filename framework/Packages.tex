...
\definecolor{myorange}{rgb}{1,0.5,0} % RGB-Werte für Orange
...
\lstset{
	...
	keywordstyle=[1]\color{blue}, % Standard Schlüsselwörter in Blau
	stringstyle=\color{red},
	numbers=left,
	numberstyle=\tiny,
	frame=single,
	deletekeywords={not, in}, % Entfernen Sie Standard-Python-Schlüsselwörter, wenn nötig
	morekeywords=[2]{Aktion, not, True, False, Hyperparameter, Schrittanzahl}, % Fügen Sie benutzerdefinierte Schlüsselwörter hinzu
	keywordstyle=[2]\color{myorange}, % Stil für benutzerdefinierte Schlüsselwörter in Orange
	literate=%
	{ä}{{\"a}}1
	{ö}{{\"o}}1
	{ü}{{\"u}}1
